package com.murillo.santiago.cazarpatos.database
...
import com.murillo.santiago.cazarpatos.Player

//class RankingPlayerDBHelper(
//    context: Context?,
//    name: String?,
//    // null if no factory is needed.
//    // Factory is used to create a cursor for the database.
//    // A cursor is an interface to access the data in the database.
//    factory: SQLiteDatabase.CursorFactory?,
//    version: Int
//) : SQLiteOpenHelper(context, name, factory, version) {

    /*RankingPlayerDBHelper is a SQLiteOpenHelper child class that manages the database for storing player rankings.*/
